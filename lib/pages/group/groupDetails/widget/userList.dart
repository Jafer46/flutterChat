...
class UserList extends GetView<GroupDetailsController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Container(
        ...
        child: CustomScrollView(
          //reverse: true,
          controller: controller.userScrolling,
          slivers: [
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                    var item = controller.state.userList[index];
                    return buildListItem(item);
                  },
                  childCount: controller.state.userList.length,
                ),
              ),
            ),
          ],
